  ...
  return (
    <div style={{ padding: '32px', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-primary)' }}>ADV Registrations</h1>
      </div>
      <p style={{ color: 'var(--text-secondary)', marginBottom: '24px', fontSize: '0.9rem' }}>Search Form ADV, ADV/A, and ADV-W investment adviser registration filings.</p>
      ...
      {loading ? (
        <div style={{ textAlign: 'center', padding: '48px', color: 'var(--text-muted)' }}><Loader2 size={24} className="spinner" style={{ marginBottom: '8px' }} /><div>Searching ADV filings...</div></div>
      ) : results.length > 0 ? (
        <>
          <AIResultsSummary
        ...
        <div style={{ textAlign: 'center', padding: '48px', color: 'var(--text-muted)' }}>No ADV filings found.</div>
      ) : (
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
            <TrendingUp size={18} style={{ color: '#F59E0B' }} />
            <h2 style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--text-primary)' }}>Recent Investment Adviser Registrations</h2>
          </div>
          {recentLoading ? (
            ...
            <div style={{ textAlign: 'center', padding: '32px', color: 'var(--text-muted)' }}>Search for investment adviser registrations above.</div>
          )}
        </div>
      )}
    </div>
