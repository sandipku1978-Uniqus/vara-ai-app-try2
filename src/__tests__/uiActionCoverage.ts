...
export const UI_ACTION_COVERAGE: Record<string, UiActionEvidence> = {
  ...
  'dashboard.add-watch-company': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the dashboard page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'dashboard.remove-watch-company': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the dashboard page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'earnings.run-search': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the earnings page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'earnings.open-result-source': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the earnings page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'exhibits.run-search': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the exhibits page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'exhibits.open-result-source': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the exhibits page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'exempt-offerings.run-search': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the exempt-offerings page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'exempt-offerings.open-result-source': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the exempt-offerings page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'support-center.filter-guidance': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the support-center page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'support-center.jump-to-section': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the support-center page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'privacy.allow-analytics': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the privacy page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'privacy.decline-analytics': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the privacy page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'privacy.return-home': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the privacy page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'terms.review-limitations': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the terms page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  'terms.return-home': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the terms page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
  ...
  'filing-detail.save-watchlist': { kind: 'manual-exception', owner: 'urc-engineering', expires: BURN_DOWN_DATE, reason: 'No executable archetype test yet for the filing-detail page; verified in the 2026-07-21 manual interaction sweep, queued for the WP8 archetype burn-down.' },
