...
export const UI_ACTION_COVERAGE: Record<string, UiActionEvidence> = {
  ...
  'earnings.cite-result': { kind: 'automated-full', specs: [{ file: 'tests/e2e/filing-search-surfaces.spec.ts', title: 'earnings.cite-result cites the exact earnings-release row with its filing identity and official exhibit' }] },
  ...
  'research-workbench.cite-result': { kind: 'automated-full', specs: [{ file: 'tests/e2e/research-workbench-interactions.spec.ts', title: 'research-workbench.cite-result cites the exact row filing into the memo tray and removes only it' }] },
  ...
  'exhibits.cite-result': { kind: 'automated-full', specs: [{ file: 'tests/e2e/filing-search-surfaces.spec.ts', title: 'exhibits.cite-result cites the exact exhibit row with its filing identity and official document' }] },
  ...
  'benchmarking.cite-passage': { kind: 'automated-full', specs: [{ file: 'tests/e2e/governance-analytics-interactions.spec.ts', title: 'benchmarking.cite-passage cites the compared section text with that peer’s exact 10-K identity' }] },
  ...
  'board-profiles.load-target': { kind: 'automated-full', specs: [
    { file: 'tests/e2e/governance-analytics-interactions.spec.ts', title: 'board-profiles.load-target resolves the requested issuer and states missing data honestly' },
    { file: 'tests/e2e/governance-analytics-interactions.spec.ts', title: 'board-profiles.load-target distinguishes a failed SEC lookup, a missing proxy, and an unreadable proxy' },
  ] },
  ...
  'board-profiles.open-proxy-source': { kind: 'automated-full', specs: [{ file: 'tests/e2e/governance-analytics-interactions.spec.ts', title: 'board-profiles.open-proxy-source opens the exact DEF 14A on SEC.gov without losing the board view' }] },
  ...
  'filing-detail.cite-evidence': { kind: 'automated-full', specs: [{ file: 'tests/e2e/filing-detail-interactions.spec.ts', title: 'filing-detail.cite-evidence cites the active section and a selected passage as distinct memo evidence' }] },
  'filing-detail.cite-redline': { kind: 'automated-full', specs: [{ file: 'tests/e2e/filing-detail-interactions.spec.ts', title: 'filing-detail.cite-redline cites a changed block against both filings with their accessions' }] },
