...
describe('runtime UI action execution evidence', () => {
  ...
  it('keeps 137 actionable contracts separate from static content and validates exact runtime identities', () => {
    expect(Object.keys(UI_ACTION_TEST_MAP)).toHaveLength(137);
    ...
    expect(browser.expectedActionCount).toBe(134);
    expect(browser.expectedTestReferenceCount).toBe(151);
