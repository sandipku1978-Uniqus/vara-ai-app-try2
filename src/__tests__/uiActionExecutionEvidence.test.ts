...
describe('runtime UI action execution evidence', () => {
  ...
  it('keeps 144 actionable contracts separate from static content and validates exact runtime identities', () => {
    expect(Object.keys(UI_ACTION_TEST_MAP)).toHaveLength(144);
    ...
    expect(browser.expectedActionCount).toBe(141);
    expect(browser.expectedTestReferenceCount).toBe(159);
