...
The UI inventory contains 144 actionable-control contracts and one required
...
The regular browser job validates 141 actions / 159 exact test references plus
