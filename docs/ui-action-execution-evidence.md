...
The UI inventory contains 138 actionable-control contracts and one required
...
The regular browser job validates 135 actions / 153 exact test references plus
